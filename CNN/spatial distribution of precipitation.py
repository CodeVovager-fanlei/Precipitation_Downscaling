...
"""
    参数
"""
load_path1 = './data/Precipitation_Prediction.pt'
load_path2 = './data/Precipitation_True.pt'
model_name = 'CNN'
save_path = '../CNN/pic/CNN_spatial_distribution.png'
########################################################################################################################
...
prior_obs_field_map(origin_data,
                    ...
                    model=['CNN'],
                    savefig_settings={
                        'path': '../CNN/pic/CNN.png',
                        'format': 'png',
                        'dpi': 600,
                        'bbox_inches': 'tight',
                        'pad_inches': 0.05
                    },
                    level=np.linspace(0, 4, 9), ticks=np.linspace(0, 4, 9)
                    )
