...
cnnModel = CNNModel(input_shape, output_shape)
cnnModel.load_state_dict(torch.load('model_parameter/CNN_Model_t2_best.pth'))
...
with torch.no_grad():
    ...
    torch.save(finalRainFall, 'data/Precipitation_Prediction-t2.pt')
