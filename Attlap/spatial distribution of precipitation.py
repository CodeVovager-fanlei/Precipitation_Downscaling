...
"""
    参数
"""
load_path1 = './data/Precipitation Prediction(ResLapv3_bicubic).pt'
load_path2 = './data/Precipitation True.pt'
model_name = 'ResLap'
save_path = '../ResLap/pic/ResLap_spatial_distribution.png'
########################################################################################################################
