# ---------------------------------------
# 论文:On the Integration of Self-Attention and Convolution (CVPR2022)
# github地址:https://github.com/LeapLabTHU/ACmix
# ---------------------------------------
"""
    ACMix模型，结合了CNN和自注意力机制
"""
...
class ACMixModel(nn.Module):
    def __init__(self, input_shape, output_shape):
        super(ACMixModel, self).__init__()

        in_channels, height, width = input_shape

        self.acmix = ACmix(in_channels, 32)
...
if __name__ == '__main__':
    ...
    block = ACMixModel((15, 6, 9), (100, 159)).to(device)

    input = torch.rand(100, 15, 6, 9).to(device)
    output = block(input)
